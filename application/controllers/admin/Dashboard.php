...
class Dashboard extends MY_Controller 
{
    ...
    public function index()
    {
        ...
        $data['order_waiting'] = $this->dashboard->where('status', 'waiting')->orderBy('date', 'DESC')->get();
        ...
        $data['order_delivered'] = $this->dashboard->where('status', 'delivered')->orderBy('date', 'DESC')->get();

        $data['order_cancel'] = $this->dashboard->where('status', 'cancel')->orderBy('date', 'DESC')->get();
