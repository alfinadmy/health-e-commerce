        ...
        <?= form_open_multipart($form_action, ['method' => 'POST']) ?>
            ...
            <div class="form-group">
                ...
                <div class="form-check form-check-inline">
                    <?= form_radio(['name' => 'type', 'value' => 'Obat', 'checked' => $input->type == 'Obat' ? true : false, 'class' => 'form-check-input']) ?>
                    <label for="" class="form-check-label">Obat</label>
                </div>
                <div class="form-check form-check-inline">
                    <?= form_radio(['name' => 'type', 'value' => 'Alat', 'checked' => $input->type == 'Alat' ? true : false, 'class' => 'form-check-input']) ?>
                    <label for="" class="form-check-label">Alat</label>
                </div>
            </div>
            <div class="form-group">
